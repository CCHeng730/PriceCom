                    ...
                    <div class="col-9">
                        <div class="tw-mx-2 tw-pb-10 tw-px-8 tw-rounded tw-bg-white tw-shadow-lg">
                            <div class="tw-px-10 tw-mb-7 tw-pt-8 tw-pb-5" style="border-bottom: 2px solid #E8E8E8;">
                                <div style="font-size: 25px;" class="tw-font-semibold tw-text-black">Account Information</div>
                                <div style="font-size: 15px;" class="tw-text-gray-500 tw-font-normal">View your personal data and secure your account.</div>
                            </div>
                            <div class="row">
                                <div class="col-4">
